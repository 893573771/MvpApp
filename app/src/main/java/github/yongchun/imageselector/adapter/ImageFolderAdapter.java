...
public class ImageFolderAdapter extends RecyclerView.Adapter<ImageFolderAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.yongchun_imageselector_item_folder,parent,false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        Glide.with(context)
                ...
                .placeholder(R.drawable.yongchun_imageselector_ic_placeholder)
                .error(R.drawable.yongchun_imageselector_ic_placeholder)
                .centerCrop()

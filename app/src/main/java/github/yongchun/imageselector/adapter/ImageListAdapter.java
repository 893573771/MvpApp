package github.yongchun.imageselector.adapter;
...
public class ImageListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_CAMERA) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.yongchun_imageselector_item_camera, parent, false);
            return new HeaderViewHolder(view);
        } else {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.yongchun_imageselector_item_picture, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            Glide.with(context)
                    ...
                    .centerCrop()
                    .thumbnail(0.5f)
                    .placeholder(R.drawable.yongchun_imageselector_image_placeholder)
                    .error(R.drawable.yongchun_imageselector_image_placeholder)
                    .dontAnimate()

 ...
 * @link https://github.com/hanks-zyh/MaterialCheckBox
 */
public class MaterialCheckBox extends View {
    ...
    private int paintCenterColor = Color.GRAY;     //边框颜色
    ...
    private void init(Context context) {
        ...
        backgroundColor = Color.BLUE; //填充颜色
        doneShapeColor = Color.WHITE; //对号颜色
        borderWidth = baseWidth = dp2px(2);
        paintCenterColor = Color.BLUE; //填充颜色
    ...
    /**设置选中前的 背景色*/
    public void setPaintCenterColor(int paintCenterColor){
        this.paintCenterColor = paintCenterColor;
        paintCenter.setColor(paintCenterColor);
    }

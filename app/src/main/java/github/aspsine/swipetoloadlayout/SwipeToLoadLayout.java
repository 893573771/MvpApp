 ...
 *          注意事项
 *          <pre>
 *                   findViewById(R.id.swipe_refresh_header);
 *                   findViewById(R.id.swipe_target);
 *                   findViewById(R.id.swipe_load_more_footer);
 *                   </pre>
...
public class SwipeToLoadLayout extends ViewGroup {
    ...
    private OnSwipeToLoadListener onSwipeToLoadListener;
    ...
    public void setOnSwipeToLoadListener(OnSwipeToLoadListener onSwipeToLoadListener) {
        this.onSwipeToLoadListener = onSwipeToLoadListener;
    }
    ...
    RefreshCallback mRefreshCallback = new RefreshCallback() {
        ...
        public void onRefresh() {
            if (mHeaderView != null && STATUS.isRefreshing(mStatus)) {
                ...
                if (onSwipeToLoadListener != null) {
                    onSwipeToLoadListener.onRefresh();
                }
            }
        }
    ...
    LoadMoreCallback mLoadMoreCallback = new LoadMoreCallback() {
        ...
        public void onLoadMore() {
            if (mFooterView != null && STATUS.isLoadingMore(mStatus)) {
                ...
                if (onSwipeToLoadListener != null) {
                    onSwipeToLoadListener.onLoadMore();
                }
            }
        }
